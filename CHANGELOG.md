...
#### [2.3.0](https://github.com/supersonic-group/n8n-nodes-qonekto/compare/2.2.1...2.3.0)

- feat(Kunde): take the API's timestamp grammar in the customer filter [`6e7be3d`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/6e7be3d8ff937550d00ca094b3aa45ee305279f1)

#### [2.2.1](https://github.com/supersonic-group/n8n-nodes-qonekto/compare/2.2.0...2.2.1)

> 23 September 2026

- docs: record the own-file-name uploads on review [`358e060`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/358e060359572d54645e1c7f41dcef882473c608)
- Release 2.2.1 [`e484fe2`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/e484fe24954e3dbd8492e0a54af2991bb422a8a7)
- fix: upload files under their own name, not the subject [`6eff548`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/6eff5486835bf93d1113da68e7dc6235d8bfcd87)

#### [2.2.0](https://github.com/supersonic-group/n8n-nodes-qonekto/compare/2.1.1...2.2.0)

> 23 September 2026

- chore(deps): apply npm audit fixes and move release-it to 20.2.0 [`0d70a4e`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/0d70a4eceb43b646ce5cc62b1965b80a5e8f7f0f)
- feat: show the node UI in English [`d410165`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/d4101652b675cf84be8fe8be6864b3e5779c85b3)
- chore(lint): use the default n8n lint config in strict mode [`45e6793`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/45e6793c82a4dc2e45a1482b259e6b6f15c61d82)

#### [2.1.1](https://github.com/supersonic-group/n8n-nodes-qonekto/compare/2.1.0...2.1.1)

> 7 September 2026

- Release 2.1.1 [`0334bb1`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/0334bb187560c38783674374a9dab6b0c59b4b67)
- ci: pin the actions to commit SHAs [`ee930d7`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/ee930d74fb6563f3f5550f1efc2eddcd99b0d8f4)

#### [2.1.0](https://github.com/supersonic-group/n8n-nodes-qonekto/compare/2.0.0...2.1.0)

> 7 September 2026

- chore: drop the vendored OpenAPI spec and its description generator [`fc2197e`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/fc2197e6146c4a4427f12c5e2c3b90e0bce836d0)
- chore(deps): upgrade the n8n toolchain to node-cli 0.46 and n8n-workflow 2.x [`981f92e`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/981f92e23b5a991726117ac54c43f52d6d52d6d2)
- feat: expose the query filters on the Tasks and Claims list operations [`960b4ba`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/960b4ba2b680303d7201c95c85a0c4ea560b4ee6)

### [2.0.0](https://github.com/supersonic-group/n8n-nodes-qonekto/compare/1.5.6...2.0.0)

> 27 March 2026

- feat(openapi): update API documentation to version 1.0.0 with expanded nodes and examples [`b563847`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/b563847b9e56b52b3af0232199628dde002c5dfc)
- feat(Qonekto): refactor ClaimsSchaden fields and shared properties [`7cf664e`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/7cf664e9e5bd1ed61de1540b757ea2bf1b54cdfb)
- feat(Qonekto): add autogenerated TasksAufgaben operations and fields [`ce4d3ee`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/ce4d3eea3aef5a1b3c6c1fff52a1244982280e50)

#### [1.5.6](https://github.com/supersonic-group/n8n-nodes-qonekto/compare/1.5.5...1.5.6)

> 26 March 2026

- Release 1.5.6 [`4176984`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/41769847232d8aadc28ca122a60586efb2c0fece)
- fix: ensure `kundensichtbar` is correctly serialized as a boolean in Qonekto node [`6cd0e14`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/6cd0e14cc60be6318b4ff9fc5f4ed366d9a946e7)

#### [1.5.5](https://github.com/supersonic-group/n8n-nodes-qonekto/compare/1.5.4...1.5.5)

> 25 March 2026

- Release 1.5.5 [`d5b52e5`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/d5b52e56ba29d1a1f01ef533142bd77bbd5b915a)
- fix: update Content-Type header to multipart/form-data in Qonekto node [`b623bf5`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/b623bf5a0e317cd354aed1c6a0de9b56f903db60)

#### [1.5.4](https://github.com/supersonic-group/n8n-nodes-qonekto/compare/1.5.3...1.5.4)

> 25 March 2026

- Release 1.5.4 [`b445aa7`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/b445aa742563ba8d7496f063a41b282147eba1c0)
- fix: add headers for multipart requests in Qonekto node [`60159da`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/60159da7a50db73f6034508acbb0657a8702dad7)

#### [1.5.3](https://github.com/supersonic-group/n8n-nodes-qonekto/compare/1.5.2...1.5.3)

> 25 March 2026

- chore: add npm publish workflow and improve CI configuration [`eba1ea1`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/eba1ea18cc4447687743dee022dc40df036ac60e)
- Release 1.5.3 [`8e10be0`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/8e10be0b2df08665bbd0d7c7213f266d29a0fd93)

#### [1.5.2](https://github.com/supersonic-group/n8n-nodes-qonekto/compare/1.5.1...1.5.2)

> 25 March 2026

- chore: update dev dependencies and adjust `dev` script [`e869f0c`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/e869f0cc10fe3b52c7a5f3dddb7051e8136888c2)
- fix: add routing logic for dynamic Kunde fields in Qonekto node [`12f1cc4`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/12f1cc4fb9d51db85e51168b81537e2b3542d237)
- Release 1.5.2 [`ee7502f`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/ee7502f571345d2d09cccc6cec0904ec569713d3)

#### [1.5.1](https://github.com/supersonic-group/n8n-nodes-qonekto/compare/1.5.0...1.5.1)

> 6 February 2026

- Release 1.5.1 [`2c03d54`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/2c03d548e6aaa1aac60ab5b5468683698b70bd55)
- fix: update parameter handling for resource locator in Qonekto node [`daaecac`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/daaecacd5ea43478d70bdb88b77dcfb29b372c5c)

#### [1.5.0](https://github.com/supersonic-group/n8n-nodes-qonekto/compare/1.4.9...1.5.0)

> 4 February 2026

- chore: update npm dependencies [`c5b2201`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/c5b220131bc5317e7e0e9f3169ed1e3077af1a53)
- refactor: remove "Import Ameise Customer into Panda" operation and related fields [`3702642`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/370264225f0b0042670ad5b84029defbb50aa0f1)
- fix: make optional fields support dynamic overrides in Qonekto node [`5781797`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/5781797c02eb055d4cac38f024fc846a667f2d54)
...
- Release 1.4.9 [`95f7f01`](https://github.com/supersonic-group/n8n-nodes-qonekto/commit/95f7f0171bffd4ad4aa9a668624f7a03947633d7)
